...
built-in Javascript methods are tested
- **forEach**
- **map**
- **filter**
- **reduce**
...
Customized **tinytest.js** file is as **simpletest.js** file in **'example'** folder. It sums up all tests in browser's window.




Tinytest JavaScript unit testing library
=======================================
